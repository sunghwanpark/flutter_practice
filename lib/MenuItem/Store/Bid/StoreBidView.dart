  ...
  void onResponseStoreElemData(String bzdtCd, Map<String, List<Map<String, String>>> res)
  {
    ...
    _detailStoreElemDatas[bzdtCd].forEach((map)
    {
      (presenter as StoreBidPresenter).onRequestStoreImageData(
          {"PAN_ID": panId, "CCR_CNNT_SYS_DS_CD" : ccrCnntSysDsCd, "PAN_KD_CD" : _defaultStoreBidDatas['BZDT_CD']["PAN_KD_CD"],
            "OTXT_PAN_ID" : _defaultStoreBidDatas['BZDT_CD']["OTXT_PAN_ID"], "TRET_PAN_ID" : _defaultStoreBidDatas['BZDT_CD']['TRET_PAN_ID'],
            "AIS_INF_SN" : _defaultStoreBidDatas['BZDT_CD']['AIS_INF_SN'], 'BZDT_CD' : _defaultStoreBidDatas['BZDT_CD']['BZDT_CD'],
            'HC_BLK_CD' : _defaultStoreBidDatas['BZDT_CD']['HC_BLK_CD'], 'DNG_SN' : map['DNG_SN'], 'SBD_NO' : map['SBD_NO']}
        );
    });
  }
